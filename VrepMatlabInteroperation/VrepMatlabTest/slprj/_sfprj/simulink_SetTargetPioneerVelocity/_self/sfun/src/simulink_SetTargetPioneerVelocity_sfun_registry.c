...
{
  extern unsigned int
    sf_simulink_SetTargetPioneerVelocity_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_simulink_SetTargetPioneerVelocity_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_simulink_SetTargetPioneerVelocity_autoinheritance_info(
  ...
  if (strcmp(machineName, "simulink_SetTargetPioneerVelocity") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simulink_SetTargetPioneerVelocity_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_simulink_SetTargetPioneerVelocity_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "simulink_SetTargetPioneerVelocity") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simulink_SetTargetPioneerVelocity_third_party_uses_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int
    sf_simulink_SetTargetPioneerVelocity_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "simulink_SetTargetPioneerVelocity") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simulink_SetTargetPioneerVelocity_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_simulink_SetTargetPioneerVelocity_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "simulink_SetTargetPioneerVelocity") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_simulink_SetTargetPioneerVelocity_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_simulink_SetTargetPioneerVelocity_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"simulink_SetTargetPioneerVelocity")) {
    return(sf_simulink_SetTargetPioneerVelocity_method_dispatcher(simstructPtr,
...
extern void simulink_SetTargetPioneerVelocity_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    simulink_SetTargetPioneerVelocity_terminator();
...
extern void simulink_SetTargetPioneerVelocity_initializer(void);
extern void simulink_SetTargetPioneerVelocity_register_exported_symbols
  (SimStruct* S);
extern void simulink_SetTargetPioneerVelocity_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  simulink_SetTargetPioneerVelocity_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      simulink_SetTargetPioneerVelocity_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    simulink_SetTargetPioneerVelocity_initializer();
  }
